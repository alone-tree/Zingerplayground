...
- 文章《如何看待现在 AI 的角色？》上线，分类 AI
- 封面图 21:9 横版，AI 生成
- 首次实践思源→翻译→网站发布流程：Hermes 读思源原文→subagent 英文翻译→写回思源子文档→生成 Hugo markdown→git push→Netlify 部署

### 流程设计

- 翻译：literary-translation skill，意译优先，保持原文语气节奏
- 封面：21:9 横版 AI 生图提示词，不强制文图呼应
- 发布：中文先上 zingerplayground，英文随后
